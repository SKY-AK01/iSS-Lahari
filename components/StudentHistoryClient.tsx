    ...
    <div className="container" style={{ paddingTop: '2rem', paddingBottom: '4rem' }}>
      ...
      {Object.keys(grouped).length === 0 ? (
        <div className="card" style={{ textAlign: 'center', padding: '3rem', opacity: 0.5 }}>
          No attempts yet. Take a test to see your history!
        </div>
      ) : (
        Object.entries(grouped).map(([subject, chapters]) => (
          <div key={subject} className="animate-up" style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.1rem', marginBottom: '0.75rem', color: 'var(--sage)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  ...
                  {chAttempts.map((a: {
                    ...
                    >
                      ...
                      >
                        ...
                        {a.percentage != null && (
                          <span style={{
                            fontFamily: 'var(--font-mono)', fontWeight: 700, fontSize: '0.9rem', minWidth: '52px', textAlign: 'right', flex: 1,
                        ...
                        <span style={{ fontSize: '0.8rem', color: 'var(--ruby)' }}>→</span>
                      </div>
                    </a>
                  ))}
                </div>
